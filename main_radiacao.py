...
grafico_real_predito(X,y,y_predict,titulo_grafico="Grafico de Valor Real x Predito (Radiação)")
...
# grafico_real_predito(X_alternativo,y,y_predict,titulo_grafico="Grafico de Valor Real x Predito (Radiação - Modelo Alternativo)")
...
# grafico_real_predito(X,y,y_predict,titulo_grafico="Grafico de Valor Real x Predito (Radiação - Sem Intercepto)")
